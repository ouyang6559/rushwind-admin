...
impl proto::gen::services::DataAccessAuditLogServiceHandlers for DataAccessAuditLogService {
    ...
    async fn get(
        ...
        let Some(proto::proto::audit::service::v1::get_data_access_audit_log_request::QueryBy::Id(
            id,
        )) = req.query_by
        else {
        ...
        let row = crate::data::audit::sys_data_access_audit_logs::Entity::find_by_id(id)
            .one(&self.state.db)
            .await
            .map_err(db_err)?
